...
func GetToolsList() ToolListResult {
	return ToolListResult{
		Tools: []Tool{
			...
			{
				Name:        "check_package",
				Description: "Checks a package before the agent recommends or installs it.",
				InputSchema: map[string]any{
					"type": "object",
					"properties": map[string]any{
						"ecosystem": map[string]any{
						...
						"repo_path": map[string]any{
							"type":        "string",
							"description": "Path to the local repository root",
							"default":     ".",
						},
						"agent": map[string]any{
							"type":        "string",
							"description": "The agent requesting the check",
						},
						"intent": map[string]any{
							"type":        "string",
						...
						"offline": map[string]any{
							"type":        "boolean",
							"description": "Run the check offline",
							"default":     false,
						},
					},
					"required": []string{"name"},
			...
			},
			{
				...
				Description: "Parse and evaluate install commands generated by AI agents.",
				InputSchema: map[string]any{
					"type": "object",
					"properties": map[string]any{
						"command": map[string]any{
							"type":        "string",
							"description": "The install command string to extract and check packages from",
						},
						"repo_path": map[string]any{
							"type":        "string",
							"description": "Path to the local repository root",
						...
						"agent": map[string]any{
							"type":        "string",
							"description": "The agent executing the command",
						},
						"offline": map[string]any{
							"type":        "boolean",
							"description": "Run the validation offline",
							"default":     false,
						},
					},
					"required": []string{"command"},
			...
			},
			{
				...
				Description: "Review dependency changes created by AI agents in branches or PRs.",
				InputSchema: map[string]any{
					"type": "object",
					"properties": map[string]any{
						"repo_path": map[string]any{
						...
						"base_ref": map[string]any{
							"type":        "string",
							"description": "Base branch or git commit ref",
							"default":     "main",
						},
						"head_ref": map[string]any{
							"type":        "string",
							"description": "Head branch or git commit ref",
				...
				InputSchema: map[string]any{
					...
					"properties": map[string]any{
						"package": map[string]any{
							"type":        "string",
							"description": "The package name or specifier (e.g. npm:express@1.0.0)",
						},
						"decision": map[string]any{
							"type":        "string",
							"description": "Optionally specify the decision to explain",
						},
						"repo_path": map[string]any{
							"type":        "string",
							"description": "Path to the local repository root",
			...
			},
			{
				...
				InputSchema: map[string]any{
					...
					"properties": map[string]any{
						...
						"decision": map[string]any{
							"type":        "string",
							"description": "The safety decision (ALLOW, WARN, BLOCK, REVIEW_REQUIRED)",
						},
						"action_taken": map[string]any{
							"type":        "string",
							"description": "The action taken by the agent (e.g. installed, skipped)",
						},
						"agent": map[string]any{
							"type":        "string",
						...
						"evidence_id": map[string]any{
							"type":        "string",
							"description": "Evidence ID associated with the decision check",
						},
						"human_approved": map[string]any{
							"type":        "boolean",
							"description": "Whether human approval was recorded for a WARN decision",
						},
					},
					"required": []string{"name", "decision", "action_taken"},
				},
			},
		},
	}
